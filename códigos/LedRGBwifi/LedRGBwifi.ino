...
const char* ssid = "Alexandre";  // Enter SSID here
const char* password = "ugkp7593";  //Enter Password here
...
String SendHTML(bool ledstat) {
  ...
  ptr += "  document.getElementById('change_color').onclick = function() {";
  ptr += "    var r = Math.round(picker.rgb[0]*4.0117);";
  ptr += "    var g = Math.round(picker.rgb[1]*4.0117);";
  ptr += "    var b = Math.round(picker.rgb[2]*4.0117);";
  ptr += "    var url = '/ledon?r=' + r + '&g=' + g + '&b=' + b;";
  ptr += "    fetch(url);";
  ptr += "  };";
  ptr += "}";
  ptr += "</script>";
